// import { ConfigInterface } from 'definixswap-sdk'
...
const config = {
  factoryAddress: isMainnet ? process.env.REACT_APP_MAINNET_FACTORY_ADDRESS : process.env.REACT_APP_TESTNET_FACTORY_ADDRESS,
