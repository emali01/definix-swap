...
const farms: FarmConfig[] = [
  ...
  },
  {
    ...
    tokenSymbol: 'FINIX',
    tokenAddresses: {
      97: process.env.REACT_APP_BNB_ADDRESS_TESTNET,
      56: process.env.REACT_APP_BNB_ADDRESS_MAINNET,
    },
    quoteTokenSymbol: QuoteToken.FINIX,
    quoteTokenAdresses: contracts.finix,
    firstSymbol: QuoteToken.FINIX,
    secondSymbol: QuoteToken.BNB,
  },
  {
    pid: 4,
